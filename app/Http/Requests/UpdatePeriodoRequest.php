...
class UpdatePeriodoRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'anio_id' => 'sometimes|required|exists:anios,id',
        ];
    }
    ...
    public function withValidator($validator)
    {
        $validator->after(function ($validator) {
            $anioId = $this->input('anio_id', $this->route('periodo') ? $this->route('periodo')->anio_id : null);
            ...
            // 3. Validar que no se crucen fechas con otros periodos del mismo año (excluyendo el propio periodo)
            $periodos = $anio->periodos()->where('id', '!=', $periodoId)->get();
